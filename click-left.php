...
$countdownDisplay = $countdownSeconds !== null
    ...
    : null;
$previousExercise = getPreviousExerciseMenuItem(basename(__FILE__), 'click-left', $items, $mode);
$previousHref = $previousExercise
    ...
    : null;
$nextExercise = getNextExerciseMenuItem(basename(__FILE__), 'click-left', $items, $mode);
...
if ($isLeftClickExercise): ?>
    ...
    <script>
        (function () {
            ...
            const exercise = document.getElementById('click-left-exercise');
            ...
            function completeExercise() {
                ...
                enableNextStep();
                showFeedback('Bravo ! Tous les smileys ont été cliqués.', 'is-success-feedback');
            }
